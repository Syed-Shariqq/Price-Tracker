...
const Login = ({setActiveTab , activeTab}) => {
  ...
  return (
     <div className='min-h-[65vh] 2xl:min-h-[70vh] flex items-center py-25 flex-col lg:h-[60vh] m-10 2xl:w-[30vw] rounded-3xl md:w-120 bg-gray-50 w-80'>
         <form 
         ...
         className='flex flex-col gap-5 items-center justify-center' action="">
            ...
            <div className='flex flex-col items-center justify-center gap-3'>
              <div className='flex items-center justify-center'>
                ...
                <input className='w-64 2xl:w-100 2xl:text-2xl 2xl:h-16 md:h-12 md:text-xl md:w-80 outline-none border-b-2 border-gray-600 h-10 p-2' name='email' type="email" placeholder='Enter Email Address' />
              </div>
                <div className='flex relative items-center justify-center'>
                  ...
                  <input className='w-64 2xl:w-100 2xl:text-2xl 2xl:h-16 md:h-12 md:text-xl md:w-80 outline-none border-b-2 border-gray-600 h-10 p-2' name='password' type={showPassword ? 'text' : 'password'} placeholder='Enter Password' />
                  {showPassword ? (
                   <Eye 
