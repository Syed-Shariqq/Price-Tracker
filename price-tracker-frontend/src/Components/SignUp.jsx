...
const SignUp = ({setActiveTab , activeTab}) => {
  ...
  return (
    ...
    <div className='min-h-[65vh] 2xl:min-h-[70vh] flex items-center justify-center flex-col lg:h-[60vh] m-10 2xl:w-[30vw] rounded-3xl md:w-120 bg-gray-50 w-80'>
           <form 
         ...
         className='flex flex-col gap-5 items-center justify-center' action="">
            ...
            <div className='flex flex-col items-center justify-center gap-3'>
              <div className='flex items-center justify-center'>
                ...
                <input className='w-64 2xl:w-100 2xl:text-2xl 2xl:h-16 md:h-12 md:text-xl md:w-80 outline-none border-b-2 border-gray-600 h-10 p-2' name='username' type="text" placeholder='Username' />
              </div>
                <div className='flex items-center justify-center'>
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-mail-icon lucide-mail"><path d="m22 7-8.991 5.727a2 2 0 0 1-2.009 0L2 7"/><rect x="2" y="4" width="20" height="16" rx="2"/></svg>
                  <input className='w-64 2xl:w-100 2xl:text-2xl 2xl:h-16 md:h-12 md:text-xl md:w-80 outline-none border-b-2 border-gray-600 h-10 p-2' name='email' type="email" placeholder='Email Address' />
                </div>
                <div className='relative flex items-center justify-center'>
                  ...
                  <input className='w-64 2xl:w-100 2xl:text-2xl 2xl:h-16 md:h-12 md:text-xl md:w-80 outline-none border-b-2 border-gray-600 h-10 p-2' name='password' type={showPassword ? 'text' : 'password'} placeholder='Password' />
                  {showPassword ? (
                   <Eye 
                ...
                <div className='relative flex items-center justify-center'>
                  ...
                  <input className='w-64 2xl:w-100 2xl:text-2xl 2xl:h-16 md:h-12 md:text-xl md:w-80 outline-none border-b-2 border-gray-600 h-10 p-2' name='confirmPassword' type={confirmPassword ? 'text' : 'password'} placeholder='Confirm Password' />
                  {confirmPassword ? (
                   <Eye 
