    ...
    <div className='shadow-2xl bg-white/80  flex items-center justify-center flex-col  m-10 2xl:w-[30vw] rounded-3xl md:w-120 w-80'>
      ...
      <form
        ...
        <div className='flex flex-col  items-center justify-center'>
          <h1 className='text-lg font-extrabold tracking-tight text-gray-900'>Sign Up Form</h1>
        ...
        <div className='flex flex-col items-center justify-center gap-3'>
          <div className='flex items-center justify-center'>
            ...
            <input
              ...
              className='w-64 transition-all focus:border-b-2 focus:border-blue-500 2xl:w-100 md:h-12 md:text-lg md:w-80 outline-none border-b-2 border-gray-600 h-10 p-2'
              name='username'
          ...
          <button
            disabled={loading}
            className={`w-64 hover:bg-blue-700 ${loading ? "cursor-not-allowed opacity-50" : ""} hover:scale-105 transition-all duration-300 active:scale-95 2xl:w-100 md:h-12 md:text-md cursor-pointer 
      ...
      <div className='flex my-5 items-center justify-center'>
        <p className='text-sm md:text-md text-gray-500'>Already have an account?
          <span
            onClick={() => setActiveTab('login')}
      ...
      <div className='flex mb-3 flex-col items-center justify-center gap-2'>
        <h1 className='text-sm font-semibold text-gray-700'>Already created an account but page reloaded?</h1>
        <button
          onClick={() => {
            if (!signUpData.email) {
          ...
          className='text-white text-sm bg-blue-500 hover:bg-blue-700 transition-all duration-300 px-4 py-2 rounded-lg font-semibold cursor-pointer'>
