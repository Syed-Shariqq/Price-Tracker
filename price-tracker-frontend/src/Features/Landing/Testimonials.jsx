...
const Testimonials = () => {
  return (
    <div className='min-h-screen bg-gray-50 py-12 md:py-16 lg:py-20 flex flex-col gap-8 md:gap-10 lg:gap-12 items-center justify-center px-4'>
      ...
      {/* Heading */}
      <h1 className='text-2xl font-extrabold tracking-tight text-gray-900 text-center'>Trusted by many Shoppers</h1>
      ...
      <div className='flex flex-col w-full sm:max-w-sm md:max-w-md border-b-2 border-gray-300 py-6 md:py-8 items-center justify-center'>
        <Quote className='w-12 h-12 md:w-16 md:h-16 lg:w-20 lg:h-20 mb-4 text-gray-400' />
        <p className='text-sm text-gray-500 leading-relaxed text-center italic py-4 md:py-6'>CostTrack has transformed the way I shop online. It saved me so much money by alerting me to price drops on items I was interested in. Highly recommend!</p>
      ...
      <div className='flex flex-col w-full sm:max-w-sm md:max-w-md border-b-2 border-gray-300 py-6 md:py-8 items-center justify-center'>
        <Quote className='w-12 h-12 md:w-16 md:h-16 lg:w-20 lg:h-20 mb-4 text-gray-400' />
        <p className='text-sm text-gray-500 leading-relaxed text-center italic py-4 md:py-6'>Simple to use and easy to navigate. It has been a game-changer for my online shopping experience.</p>
        <div className='flex gap-3 items-center justify-center mt-4'>
          ...
          <p className='text-base font-semibold text-gray-900'>Jane Smith</p>
        </div>
      </div>
